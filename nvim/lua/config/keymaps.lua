...
map("n", "q", "<cmd>close<cr>", { desc = " delete buffer " })
map("n", "<leader>e", "<cmd>NvimTreeToggle<cr>", { desc = "nvim-tree" })
-- map("n", "<leader>e", "<cmd>Neotree<cr>", { desc = "nvim-tree" })
map("n", "<leader>9", "gg<S-V><S-G> <CR>", { desc = "select_all" })
map("n", "<leader>zn", ":ZenMode <CR>")
map("i", "jk", "<ESC>", { desc = "jk for escape" })
map("i", "kj", "<ESC>", { desc = "jk for escape" })
map("n", "<leader>8", ":AerialToggle<CR>", { desc = "Toggles Aerial " })
...
--   return vim.fn["codeium#cCycleCompletions"](1)
-- end)
-- vim.keymap.set("i", "<S-Tab>,", function()
--   return vim.fn["codeium#cCycleCompletions"](-1)
-- end)
-- vim.g.codeium_disable_keymap = true
-- vim.keymap.set("i", "<Tab>a", function()
